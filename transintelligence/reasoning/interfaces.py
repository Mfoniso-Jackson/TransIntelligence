...
class Simulator(Protocol):
    def simulate(self, state: Any, policy: Callable[[Any, int, Any], Any],
                 transition_fn: Callable[[Any, Any, Any], Any],
                 score_fn: Callable[[Any], float], horizon: int, rng: Any) -> list[float]: ...
    def compare_policies(self, state: Any, policy_a: Callable[[Any, int, Any], Any],
                          policy_b: Callable[[Any, int, Any], Any],
                          transition_fn: Callable[[Any, Any, Any], Any],
